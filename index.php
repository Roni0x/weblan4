...
//$_SERVER - это суперглобальный массив, который содержит информацию о сервере и запросе.
...
if ($_SERVER['REQUEST_METHOD'] == 'GET') {
    ...
    // Проверяем, есть ли кука с признаком успешного сохранения,Куки - это маленькие файлы, которые браузер хранит на компьютере пользователя.
